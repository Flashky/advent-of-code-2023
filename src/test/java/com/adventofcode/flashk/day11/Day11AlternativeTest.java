...
@Disabled
public class Day11AlternativeTest extends PuzzleTest {
	...
	public void testSolvePart1Sample() {
		...
		CosmicExpansionRefactor cosmicExpansion = new CosmicExpansionRefactor(inputs);
		long result = cosmicExpansion.solve(2);
